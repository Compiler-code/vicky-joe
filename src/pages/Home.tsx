    ...
    <div className="min-h-screen">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-sm tracking-widest uppercase text-gray-400">Discover Our Most Coveted Pieces</p>
        </div>
      ...
      {/* Brand Story */}
      <section className="bg-brand-secondary py-32 px-4 sm:px-6 lg:px-8">
